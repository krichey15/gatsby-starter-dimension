    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>
            On this project I worked with Simply Seattle to create a responsive addition to the footer of the website. It is visible across all pages and includes the 12 links as shown in the photo. I also cleaned up and debugged a portion of the code base. This project was mainly done in Shopify using CSS and JavaScript. 
          </p>
          <hr/>
